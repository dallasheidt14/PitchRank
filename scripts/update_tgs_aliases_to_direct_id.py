...
result = (
    ...
    .select("id,provider_team_id,match_method,review_status,team_id_master")
...
aliases_to_update = [r for r in result.data if r["match_method"] != "direct_id" and r.get("provider_team_id")]

...
def main():
    ...
    parser.add_argument(
        "--since-date", type=str, default=None, help="Only include games after this date (YYYY-MM-DD format)"
    )
    parser.add_argument(
        "--output", type=str, default=None, help="Output CSV file path (default: stdout or auto-generated filename)"
    )
    parser.add_argument("--save-html", type=str, default=None, help="Save fetched HTML to file for debugging")
    parser.add_argument(
        "--load-from-file",
        type=str,
        default=None,
    ...
    # Scrape games
    console.print("[cyan]Scraping conference schedule...[/cyan]")

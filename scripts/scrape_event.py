...
def scrape_event(
    event_id: str = None, event_url: str = None, event_name: str = None, output_file: str = None, since_date: str = None
):
    """
    ...
    # Scrape games
    console.print("[bold cyan]Scraping event...[/bold cyan]")
    if event_url:
        ...
        if since_date_obj is None:
            console.print("[dim]No date filter - scraping all games from event teams[/dim]")

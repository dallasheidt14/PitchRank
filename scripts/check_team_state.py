...
result = (
    ...
    .select("team_id_master, team_name, state_code, state, club_name, age_group, gender")
...
state_ranking_result = (
    supabase.table("state_rankings_view").select("team_id_master, state").eq("team_id_master", team_id).execute()
)

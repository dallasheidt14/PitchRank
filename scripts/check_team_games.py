...
print(
    f"Team ID {provider_team_id} found in CSV: "
    f"{provider_team_id in team_ids_in_csv or provider_team_id in opponent_ids_in_csv}"
)
...
home_games = (
    ...
    .select(
        "game_uid, game_date, home_score, away_score, "

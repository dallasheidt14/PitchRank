...
for game in problematic_games[:10]:
    print(
        f"  {game['game_date']}: {game['home_team']} ({game['home_age']}) vs {game['away_team']} ({game['away_age']})"
    )
...
print("  2. Export list of game UIDs for review")
print("  3. Show detailed breakdown by team")
print("=" * 70)

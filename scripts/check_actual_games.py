...
games = (
    ...
    .select("game_uid, game_date, home_provider_id, away_provider_id, home_team_master_id, away_team_master_id")
    .eq("home_provider_id", "79561")
    .eq("provider_id", tgs_id)
    .limit(5)
    .execute()
)
    ...
    for g in games.data:
        ...
        if g["home_team_master_id"]:
            team = (
                ...
                .eq("team_id_master", g["home_team_master_id"])
                .execute()
            )
            if team.data:

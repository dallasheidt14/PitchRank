...
def list_teams(event_id: str = None, event_url: str = None):
    ...
    for bracket_name, teams in sorted_brackets:
        ...
        for team in sorted_teams:
            ...
            table.add_row(team.team_id, team.team_name, age_display, gender_display, playing_up_display)
    ...
    console.print("  [dim]1. Review teams by bracket in the JSON file[/dim]")
    console.print("  [dim]2. Use PitchRank compare feature to audit bracket placements[/dim]")

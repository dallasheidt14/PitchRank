...
games_result = (
    ...
    .select("home_team_master_id, away_team_master_id, created_at")
    .eq("provider_id", tgs_provider_id)
    .gte("created_at", "2025-12-11T13:35:00")
    .execute()
)
...
for team_id_master in sorted(team_ids):
    ...
    tgs_team_result = (
        ...
        .select("team_id_master, team_name, provider_team_id, created_at, updated_at")

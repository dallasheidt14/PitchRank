...
unmatched_games = (
    ...
    .select("id, game_uid, game_date, home_provider_id, away_provider_id, home_team_master_id, away_team_master_id")
    .eq("provider_id", modular11_provider_id)
    .or_("home_team_master_id.is.null,away_team_master_id.is.null")
    .execute()
)
...
aliases_result = (
    ...
    .select("provider_team_id, team_id_master, review_status")
    .eq("provider_id", modular11_provider_id)
...
for game in unmatched_games.data:
    ...
    if home_team_id or away_team_id:
        ...
        if update_data:
            updates.append({"game_id": game_id, "update_data": update_data})
            matched_count += 1

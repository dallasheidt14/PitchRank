#!/usr/bin/env python3
"""Quick count of teams with missing state_code."""
...
r1 = (
    db.table("teams")
    .select("team_id_master", count="exact", head=True)
...
print(f"Teams with state_code NULL: {null_count:,}")
print(f"Teams with state_code empty: {empty_count:,}")

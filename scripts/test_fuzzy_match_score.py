...
from src.models.tgs_matcher import TGSGameMatcher  # noqa: E402
...
print("\nTGS Team (from CSV):")
print("  Name: Eastside FC ECNL B12")
print("  Club: Eastside FC")
print("  Age Group: u14")
print("  Gender: Boys")
...
candidate_normalized = matcher._normalize_team_name(
    target_team_data.get("team_name"), target_team_data.get("club_name")
)
...
if score < matcher.fuzzy_threshold:
    ...
    print("   This caused the system to create a NEW team instead of matching.")
    print("\n   The TGS matcher behavior:")
    print("   1. Tries base matching (direct ID, alias, fuzzy)")
    print("   2. If no match found → Creates NEW team")
    print("   3. Creates alias for NEW team (not existing team)")
    print("\n   This is why there's no alias linking TGS 79561 to GotSport team.")
else:
    print(f"\n✅ Fuzzy matching SHOULD have worked (score: {score:.4f})")
    print("   But something else prevented the match.")

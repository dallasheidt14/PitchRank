...
SUPABASE_KEY = (
    ...
    "eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBma3JobXByd3h0Z2h0cGlucm90Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE3NDQ3ODQsImV4cCI6MjA3NzMyMDc4NH0."
        ...
        if caps:
            ...
            for fix in sorted(caps, key=lambda x: x['from']):
                ...
                sql = (
                    ...
                    f" AND state_code = '{state}' AND gender = 'Male';"
                )
                lines.append(sql)
                lines.append("")

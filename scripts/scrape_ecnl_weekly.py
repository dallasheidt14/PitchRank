...
def save_scraped_conference(scraped_file: Path, conference_key: str):
    ...
    data = {"conferences": list(scraped_conferences), "last_updated": datetime.now().isoformat()}
...
Examples:
  ...
  python scripts/scrape_ecnl_weekly.py \\
    ...
    parser.add_argument("--days-back", type=int, default=7, help="How many days back to scrape games (default: 7)")

...
def get_account_info():
    ...
    response = requests.get(
        ...
        params={"fields": "id,username,profile_picture_url,followers_count", "access_token": INSTAGRAM_ACCESS_TOKEN},
    )
...
def check_media_status(container_id: str):
    ...
    response = requests.get(
        f"{GRAPH_API_URL}/{container_id}", params={"fields": "status_code", "access_token": INSTAGRAM_ACCESS_TOKEN}
    )
...
def main():
    ...
    parser.add_argument("--movers", action="store_true", help="Post the weekly movers infographic")
    parser.add_argument(
        "--platform", type=str, default="instagram", help="Infographic platform size (instagram, story)"
    )
    parser.add_argument("--check-account", action="store_true", help="Verify Instagram account connection")

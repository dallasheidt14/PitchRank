-- Fix rankings_view performance by using pre-computed rank_in_cohort_ml
-- This migration must run AFTER 20251124000000_add_sos_ranks_to_views.sql
-- to ensure the performance fix is applied to the final view definitions
-- Date: 2025-11-25
...
-- =====================================================
-- Step 2: Recreate rankings_view using pre-computed rank_in_cohort_ml
-- =====================================================
...
COMMENT ON VIEW rankings_view IS 'National rankings view using rankings_full as primary source. Uses pre-computed rank_in_cohort_ml instead of computing dynamically for performance. Exposes sos_norm (national) and sos_norm_state (state-normalized) for proper display in state vs national views. Respects RLS policies.';

-- Add sos_norm to rankings_view and state_rankings_view
-- This exposes the normalized SOS value (percentile/z-score within cohort)
-- in addition to the raw sos value
...
-- =====================================================
-- Step 2: Recreate rankings_view with sos_norm
-- =====================================================
...
COMMENT ON VIEW rankings_view IS 'National rankings view reading from rankings_full (with fallback to current_rankings). Includes power_score_final with ML > global > adj > national fallback. Exposes both raw sos and normalized sos_norm. Respects RLS policies.';

-- =====================================================
-- Step 3: Recreate state_rankings_view with sos_norm
-- =====================================================
...
COMMENT ON VIEW state_rankings_view IS 'State rankings view: National rankings filtered by state_code, with dynamically calculated state_rank and state_sos_rank. Exposes both raw sos and normalized sos_norm. Reads from rankings_full via rankings_view. Respects RLS policies.';

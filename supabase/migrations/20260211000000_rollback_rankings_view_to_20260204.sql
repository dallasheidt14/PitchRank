-- Rollback: Restore rankings_view to the 20260204000000 definition
-- Date: 2026-02-11
-- Reason: Migration 20260210000000 added IN subqueries against team_merge_map
--         in every correlated subquery. With 66k+ teams, this caused the view
--         to time out when queried, resulting in "no teams available."
--
-- The game count fix for merged teams is handled in the API layer (api.ts getTeam)
-- which only runs for one team at a time and has no performance issue.
...
-- =====================================================
-- Step 2: Recreate rankings_view (exact copy of 20260204000000)
-- =====================================================

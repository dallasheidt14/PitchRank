...
These clubs compete in various leagues — from local recreational leagues to ECNL, MLS Next, national-league play, and the Colorado State Cup run by [Colorado Soccer Association](https://www.coloradosoccer.org/).

...
US Club Soccer's competitive tier directly below ECNL, with a strong national showcase calendar. It's the typical home for clubs that are competitive but don't hold an ECNL bid in a given age group.

**This one just changed.** US Club Soccer ran the [final NPL season in 2026](https://usclubsoccer.org/2026-npl-finals-crowns-champions-capping-final-season-as-transition-begins-to-national-1-league/) and is replacing the National Premier Leagues with the National 1 League — a joint competition with US Youth Soccer, integrated with the ECNL and backed by U.S. Soccer. Entry criteria and structure have not been published yet, so treat any source that states them confidently with suspicion. [What the change means for your club](/blog/ecnl-vs-npl).

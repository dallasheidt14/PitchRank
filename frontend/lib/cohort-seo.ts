...
export const STATE_PILLAR_SLUGS: Record<string, { slug: string; title: string }> = {
  ...
  ct: { slug: 'connecticut-youth-soccer-rankings-guide', title: 'Connecticut Youth Soccer Rankings Guide' },
  ...
  mn: { slug: 'minnesota-youth-soccer-rankings-guide', title: 'Minnesota Youth Soccer Rankings Guide' },
  mo: { slug: 'missouri-youth-soccer-rankings-guide', title: 'Missouri Youth Soccer Rankings Guide' },
  nv: { slug: 'nevada-youth-soccer-rankings-guide', title: 'Nevada Youth Soccer Rankings Guide' },
  ...
  oh: { slug: 'ohio-youth-soccer-rankings-guide', title: 'Ohio Youth Soccer Rankings Guide' },

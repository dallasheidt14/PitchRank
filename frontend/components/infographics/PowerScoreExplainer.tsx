 ...
 * Based on actual PitchRank methodology
 * Brand: PitchRank Creative Kit
 */

interface PowerScoreExplainerProps {
  variant?: 'square' | 'portrait';
}

export function PowerScoreExplainer({ variant = 'square' }: PowerScoreExplainerProps) {
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex items-center gap-2 mb-6">
          <div className="relative">
            <div 
              className="absolute w-1.5 h-full bg-[#F4D03F] -left-4 top-0"
...
export default PowerScoreExplainer;

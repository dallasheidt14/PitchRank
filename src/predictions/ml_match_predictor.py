...
from sklearn.metrics import accuracy_score, log_loss, mean_absolute_error, mean_squared_error  # noqa: E402
...
class MLMatchPredictor:
    ...
    def __init__(
        self, model_dir: str = "models/match_predictor", lookback_days: int = 365, min_games_per_team: int = 5
    ):
        """
    ...
    def build_features(
        ...
        for idx, game in games_df.iterrows():
            ...
            feature_dict = {
                ...
                "sos_diff": (home_rank.get("sos_norm", 0.5) or 0.5) - (away_rank.get("sos_norm", 0.5) or 0.5),
    ...
    def train(self, features_df: pd.DataFrame, test_size: float = 0.2, random_state: int = 42) -> Dict:
        """
        ...
        (
            ...
            X, y_winner, y_margin, y_home_score, y_away_score, test_size=test_size, random_state=random_state
        )
        ...
        self.win_probability_model.fit(X_train_fit, y_train_fit, eval_set=[(X_val, y_val)], verbose=False)
        ...
        # Evaluate models
        print("\nEvaluating models...")
        metrics = self._evaluate_models(X_test, y_winner_test, y_margin_test, y_home_test, y_away_test)
    ...
    def predict(self, team_a_features: Dict, team_b_features: Dict, is_home_away: bool = True) -> MatchPrediction:
        """

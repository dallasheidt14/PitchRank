        ...
        evaluation_frame = pd.DataFrame(
            {
                ...
                "team_a_is_female": test_df["team_a_is_female"].astype(float).to_numpy(),
                "team_b_is_female": test_df["team_b_is_female"].astype(float).to_numpy(),
                "team_a_games_played": test_df["team_a_games_played"].astype(float).to_numpy(),
                "team_b_games_played": test_df["team_b_games_played"].astype(float).to_numpy(),

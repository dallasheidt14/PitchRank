...
class EnhancedETLPipeline:
    ...
    def _ensure_initialized(self):
        """Lazy init: DB lookups, health check, alias cache, and matcher setup.

        Deferred from __init__ so the constructor doesn't perform network I/O,
        making the class easier to instantiate in tests and dry-run scenarios.
        """
        ...
        # Preload alias cache (paginated to avoid 1000-row limit)
        try:
            all_alias_data = []
            page_size = 1000
            offset = 0

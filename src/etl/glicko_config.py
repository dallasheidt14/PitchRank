...
class GlickoConfig:
    ...
    BASE_EVIDENCE_SHRINK_DILUTED: float = 0.03
    BASE_EVIDENCE_SHRINK_DILUTED_STRONG: float = 0.05
    BASE_EVIDENCE_SHRINK_DILUTED_MIN_TOP100: int = 2
    BASE_EVIDENCE_SHRINK_DILUTED_STRONG_MIN_TOP100: int = 3
    BASE_EVIDENCE_SHRINK_DILUTED_MIN_TOP500: int = 4
    BASE_EVIDENCE_SHRINK_DILUTED_MAX_TOP500_NON_LOSS: int = 4
    BASE_EVIDENCE_SHRINK_DILUTED_STRONG_MAX_TOP500_NON_LOSS: int = 3
    ...
    BASE_EVIDENCE_SHRINK_DILUTED_MAX_AVG_OPP_STRENGTH: float = 0.54
    BASE_EVIDENCE_SHRINK_DILUTED_STRONG_MAX_AVG_OPP_STRENGTH: float = 0.51

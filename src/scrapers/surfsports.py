...
class SurfSportsScraper(BaseScraper):
    ...
    def _scrape_event_games(
        ...
        try:
            schedule_ids = self._extract_schedule_ids_with_selenium(event_id, gender_filter, age_group_filter)
            ...
            for schedule_id in schedule_ids:
                try:
                    schedule_games = self._scrape_schedule_page(event_id, schedule_id, event_name, since_date)
    ...
    def _extract_schedule_ids_with_selenium(
        self, event_id: str, gender_filter: Optional[str] = None, age_group_filter: Optional[str] = None
    ) -> List[str]:
        """
        ...
        try:
            ...
            try:
                ...
                schedule_ids = set(self._extract_schedule_ids_from_html(soup, gender_filter, age_group_filter))
    ...
    def _get_known_schedule_ids_4067(
        self, gender_filter: Optional[str] = None, age_group_filter: Optional[str] = None
    ) -> List[str]:
        """
    ...
    def _extract_schedule_ids_from_html(
        self, soup: BeautifulSoup, gender_filter: Optional[str] = None, age_group_filter: Optional[str] = None
    ) -> List[str]:
        """
    ...
    def _scrape_schedule_page(
        self, event_id: str, schedule_id: str, event_name: str, since_date: Optional[datetime] = None
    ) -> List[GameData]:
        """

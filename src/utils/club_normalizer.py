...
CANONICAL_CLUBS: Dict[str, List[str]] = {
    ...
    "COLORADO RAPIDS": ["colorado rapids", "col rapids", "corap", "colorado rapids youth soccer club"],
    ...
    "CONCORDE FIRE": ["concorde fire", "cfire", "concorde fire soccer club"],
    "FC UNITED": ["fc united"],
    ...
    "SACRAMENTO UNITED": ["sacramento united", "sac united", "sacramento utd", "sacramento united soccer club"],
    "SC WAVE": ["sc wave"],
    "NEFC": ["nefc", "new england football club"],
    "GFI ACADEMY": ["gfi academy", "global football innovation academy", "gfi", "gfia"],
    "KINGS HAMMER": ["kings hammer", "kings hammer fc", "kings hammer academy", "kings hammer soccer club"],
    ...
    "CLUB OHIO": ["club ohio", "ohio soccer", "club ohio soccer"],
    "CITY SC": ["city sc", "city soccer club"],
    "VENTURA COUNTY FUSION": [
        "ventura county fusion",
        "vc fusion",
        "ventura fusion",
        "ventura county fusion youth sa",
        "ventura county fusion ys",
    ],
    "BALLISTIC UNITED": ["ballistic united", "ballistic", "ballistic sc", "ballistic united sc"],
    ...
    "VARDAR SOCCER CLUB": ["vardar soccer club", "vardar", "vardar sc", "vardar soccer", "fc vardar"],
    ...
    "SEACOAST UNITED": ["seacoast united", "seacoast utd", "seacoast united sc"],
    "COPPERMINE SC": ["coppermine sc", "coppermine soccer club"],
    "TSF ACADEMY": ["tsf academy", "the soccer factory"],
    "INDY ELEVEN": ["indy eleven", "indianapolis eleven", "indy 11", "indy eleven academy"],
    ...
    "DALLAS HORNETS": ["dallas hornets", "dallas hornets youth"],
}

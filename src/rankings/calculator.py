...
async def compute_rankings_with_ml(
    ...
    _cfg_dict = {
        ...
        "sos_cw": getattr(_ecfg, "SOS_CREDIT_RECORD_WIN_WEIGHT", None),
        "sos_cg": getattr(_ecfg, "SOS_CREDIT_RECORD_GD_WEIGHT", None),
        "sos_cmg": getattr(_ecfg, "SOS_CREDIT_MIN_GAMES_FULL", None),
